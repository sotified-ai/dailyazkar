    ...
    return (
        <div className="pt-24 bg-gradient-to-br from-gray-50 via-white to-gray-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900 min-h-screen">
            <SEOHead
                ...
                canonical="https://dailyazkar.site/daily-blogs"
            ...
            <div className="container mx-auto px-4 py-8">
                        ...
                        <Card key={post.slug} className="glassmorphism border-0 overflow-hidden transform hover:-translate-y-1 transition-all duration-300 shadow-md hover:shadow-xl group">
                            <div className="h-64 overflow-hidden relative">
                                ...
                                <div className="absolute top-4 left-4 flex flex-col space-y-2">
                                    ...
                                    {post.isTrending && (
                                        <span className="self-start px-3 py-1 bg-rose-500 text-white text-xs font-semibold rounded-full shadow-sm flex items-center animate-pulse">
                            ...
                            <CardContent className="p-8">
                                ...
                                <h2 className="text-2xl font-bold text-gray-800 dark:text-white mb-3 group-hover:text-emerald-600 dark:group-hover:text-emerald-400 transition-colors">
                                    <Link href={`/daily-blogs/${post.slug}`} className="block">{post.title}</Link>
                                </h2>
                                <p className="text-gray-600 dark:text-gray-300 mb-6 line-clamp-3">
                                    {post.excerpt}
                                </p>
                                <Link href={`/daily-blogs/${post.slug}`} className="flex items-center font-medium text-emerald-600 dark:text-emerald-400 cursor-pointer">
                                    <span>Read More</span>
                ...
                <div className="text-center">
                    <button className="px-8 py-3 bg-white dark:bg-gray-800 border-2 border-gray-200 dark:border-gray-700 hover:border-emerald-500 dark:hover:border-emerald-500 text-gray-700 dark:text-gray-300 hover:text-emerald-600 dark:hover:text-emerald-400 font-medium rounded-full transition-all shadow-sm">
                        Load More Articles
                    </button>
                </div>
            </div>
